...
The CRUD interface is implemented in the React component \texttt{GameManagement.jsx}. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{graphics/crud_interface.png}
    \caption{CRUD interface for managing game records}
    \label{fig:crud-interface}
\end{figure}
