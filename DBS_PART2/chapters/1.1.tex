...
\noindent\textit{The interface illustrates that Steam functions as an integrated digital distribution and community platform rather than a standalone online storefront. This makes it a suitable primary reference system for the proposed system.}
...
\begin{figure}[h!]
    ...
    \label{fig:steam_library_detail}
